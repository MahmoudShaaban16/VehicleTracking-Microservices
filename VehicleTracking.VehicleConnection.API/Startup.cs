    ...
    public class Startup
    {
        ...
        private static async Task<VehicleConnectionRepository> InitializeCosmosClientInstanceAsync(IConfigurationSection configurationSection)
        {
            ...
            CosmosClient client = clientBuilder
                                ...
                                .Build();
            VehicleConnectionRepository vehicleConnectionRepository = new VehicleConnectionRepository(client, databaseName, containerName);
            DatabaseResponse database = await client.CreateDatabaseIfNotExistsAsync(databaseName);
            await database.Database.CreateContainerIfNotExistsAsync(containerName, "/id");

            return vehicleConnectionRepository;
        }
